...
| CMS | `PASS — STEP 33 DOMAIN/ADMIN/PUBLIC SLICES`; Page and Article/FAQ/Banner scheduler idempotency, replacement revision/live preservation, unpublish, separate manage/publish authority, immutable guards, governed cross-domain media references/orphan protection, Admin workspace, published-only SSR, safe CTA and Email Template whitelist/injection controls; full suite 163/1129; remaining MySQL/browser gates explicit |
| Technical SEO | `PASS — STEP 34 STRUCTURED-DATA SLICE`; explicit canonical/robots, public-sellable sitemap, stable pagination canonical/prev/next, approved Product schema inventory/composer with exact decoded-payload assertions, faceted/transactional noindex and direct-to-current active slug redirects pass; Technical SEO 5/51 and full regression 176/1235; landing-page and browser/production-host gates remain |
| Merchant and Analytics | `PASS — STEP 35 PROVIDER-NEUTRAL SLICE`; authoritative Catalog/Pricing/Inventory feed reconstruction, stable operation identity, partial retry, disabled-provider safety, exact event allow-list, consent/PII fail-closed policy, destination/event dedupe and private Analytics monitor pass; focused 8/51 and full regression 176/1235; attribution, concrete providers and staging/load/privacy gates remain |
| Transactional outbox | `PASS — STEP 48 ORDER/CATALOG FACT SLICE`; Checkout/Quote success stores one versioned Order fact atomically, Catalog mutations store versioned projection facts, exact retry does not duplicate, rollback leaves none, conflicting identity fails closed, relay persists publish evidence and consumer failure retries then dead-letters; Search invalidation consumes released Catalog facts and the private high-permission/2FA monitor exposes backlog evidence without payload; focused Checkout/Quotation/Outbox/Foundation 18/120, Catalog/Search/Outbox 15/84 and full regression 176/1235; MySQL SKIP LOCKED concurrency and operational alert/reconciliation gates remain |
