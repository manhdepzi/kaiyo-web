...
- Last updated: 2026-08-27 — Steps 00–28 completed; Steps 29–35 have gated slices; Step 35 delivery monitors and Step 48 transactional Order/Catalog outbox slices pass; Steps 49–54 controls active
...
| [V1 ERD and entity catalog](./docs/architecture/v1-erd.md) | Step 06 approved logical aggregates/cardinalities; physical schema/migrations remain Step 07/11 gated |
| [Schema dictionary](./docs/database/schema-dictionary.md) | Step 07 approved MySQL 8.4 table/type/FK/unique/check/state/retention design; no migration created |
...
| 11 | V1 / Layer 3 | Laravel Foundation | `DONE` | Steps 00–10 and early `49`–`54` controls passed; PHP 8.5 target verified | Laravel 13/Livewire foundation, environment-driven services, health/readiness, correlation logging, explicit proxy/cookie security, tests/static/style/build and CI baseline implemented without feature schema | [Step 11 task/evidence](./docs/tasks/step-11-laravel-foundation.md) and reproducible foundation | PHP 8.3.30 + official PHP 8.5.9: 6 tests/11 assertions; Pint/Larastan 8/build/audits/OpenAPI/cache checks pass | Fresh boot, tests and build pass |
...
| 22 | V1 / Layer 3 | Order | `DONE` | Steps 03, 05–08, 13, 16–17, 20–21 passed | Implemented exact evidence-bound ORD-L1 forward state machine, scoped CANCEL-D1 request/decision, immutable audit, dispatch Inventory commit and atomic cancellation release/Payment preparation | [Step 22 task/evidence](./docs/tasks/step-22-order.md), lifecycle migration/actions/tests | Order 3/16; full SQLite 78/512; MySQL critical 28/119; 7 CHECKs/7 triggers; standalone rollback/re-migrate passed | Illegal/stale transitions blocked; cancellation boundary and compensation atomic |
| 23 | V1 / Layer 3 | Payment | `DONE — PROVIDER-NEUTRAL CORE` | Steps 03, 05–09, 13, 16, 21–22 and D-004/D-007 passed; named online gateway remains disabled | Implemented separate Payment/Attempt/Transaction/Event/Refund/Reconciliation truth, Checkout registration, verified Order/Inventory binding, authenticated adapter callbacks and dual-control full refund | [Step 23 task/evidence](./docs/tasks/step-23-payment.md), Payment migration/domain/adapters/tests | Full SQLite 81/541; Payment 3/29 plus one MySQL-only skip; MySQL critical 32/150 and focused Payment 4/31; nine CHECKs/eight triggers; rollback/re-migrate passed | Duplicate/conflicting/out-of-order webhook and refund effects are safe; unknown results reconcile |
| 24 | V1 / Layer 3 | Shipping | `DONE — PROVIDER-NEUTRAL CORE` | Steps 03, 05–09, 13, 17, 21–23 and D-004/D-007 baseline passed; named carrier remains disabled | Implemented configured/manual single-Shipment truth, complete item lineage, evidence-bound warehouse lifecycle, carrier adapter isolation, authenticated monotonic tracking and reconciliation | [Step 24 task/evidence](./docs/tasks/step-24-shipping.md), Shipping migration/actions/adapters/tests | Full SQLite 85/571; Shipping 4/30 plus one MySQL-only skip; MySQL critical 37/182; seven CHECKs/seven triggers and rollback/re-migrate passed | Carrier outage is visible and does not block commerce core; duplicate/out-of-order effects are safe |
| 25 | V1 / Layer 3 | Quotation | `DONE — DOMAIN CORE` | Steps 03, 05–08, 12–19 and approved D-001–D-005 passed | Implemented opaque guest/authenticated-Customer creation, anti-abuse, deterministic snapshots, exact approval tiers/SoD, immutable recalculated revisions and guarded issue/access/accept/reject/expiry lifecycle | [Step 25 task/evidence](./docs/tasks/step-25-quotation.md), Quotation migration/domain/actions/tests | Full SQLite 100/622; MySQL critical 44/226 and Quotation 7/44; six CHECKs/ten triggers; standalone rollback/re-migrate, PHPStan 8 and Pint pass | Accepted/source revisions remain immutable; approvals do not carry; exact lifecycle enforced |
| 26 | V1 / Layer 3 | Quote to Order | `DONE — TRANSACTIONAL CORE` | Steps 17, 21–25 and approved conversion/reservation rule passed | Implemented permission-gated one-time Accepted revision conversion with exact snapshots, deterministic stock allocation/reservation, Payment/Shipping registration, durable idempotency and full rollback | [Step 26 task/evidence](./docs/tasks/step-26-quote-to-order.md), conversion migration/action/tests | Full SQLite 102/638; MySQL critical 46/242 and focused Quotation 9/60; source XOR/unique constraints, rollback/re-migrate, PHPStan 8 and Pint pass | Exactly one Order per Accepted revision; stock failure leaves no partial effect |
...
| 29 | V1 / Layer 4 | Public Website | `IN PROGRESS — CONTACT/BROWSER GATE` | Steps 15–21, 25 and 27–28 passed; Step 33 Page integration available | Public shell/Catalog plus secure Cart, Customer Checkout/receipt, guest/authenticated Quotation and published CMS Page SSR are implemented through domain actions/DTOs; Contact command remains | [Step 29 task/evidence](./docs/tasks/step-29-public-website.md), public controllers/views/DTO readers/tests | Focused public tests plus full regression 147/940; active-only/SSR/sanitization/idempotency/conflict/fail-closed/ownership/access-isolation checks, build, PHPStan 8 and Pint pass | Commerce and Page read flows pass; final Contact/browser gates remain |
| 30 | V1 / Layer 4 | Customer Portal | `IN PROGRESS — MISSING-DOMAIN GATES` | Steps 12–14, 19, 22–26, 27–28 passed | Profile, dashboard, own Order detail, Quotation lifecycle and Security implemented; Address/Wishlist/Review/Notification contracts and cancellation entitlement remain open | [Step 30 task/evidence](./docs/tasks/step-30-customer-portal.md), portal/security controllers, DTO queries, views and tests | Self-provision fail-closed, ownership isolation, optimistic profile update, session revocation and private-response checks pass | Partial; missing-domain and final browser/query gates remain |
...
| 33 | V1 / Layer 3 | CMS | `IN PROGRESS — MYSQL/BROWSER GATES` | Steps 03, 05–07, 10–13, 19, 27–28 passed; isolated MySQL/browser gates pending | Type-specific roots/revisions, immutable lineage, replacement/live preservation, unpublish, Page/Article/FAQ/Banner schedules, governed media references/orphan protection, private Admin workspace, sanitized public projections, safe CTA and Email Template controls are implemented; finish environment evidence | [Step 33 task/evidence](./docs/tasks/step-33-cms.md), CMS migrations/actions/queries/controllers/views/tests | CMS/Media focused 20/194 and full regression 163/1129; permission/2FA/private-header/optimistic/idempotent/stale-schedule/media/query-bound/sanitization/injection checks, PHPStan 8, Pint and build pass | Domain/Admin/public lifecycle and media pass; MySQL/browser gates remain |
| 34 | V1 / Layer 4 | Technical SEO | `IN PROGRESS — LANDING/BROWSER/PRODUCTION GATES` | Steps 02–04, 15, 27–29 and available Step 33 public contracts passed | Explicit canonical/robots, public-sellable sitemap, stable pagination, approved Product schema inventory/composer, transactional noindex and direct-to-current active Catalog redirects implemented; finish approved landing pages and browser/production-host evidence | [Step 34 task/evidence](./docs/tasks/step-34-technical-seo.md), [schema inventory](./docs/seo/structured-data-inventory.md), SEO controllers/layout/redirect resolver/tests | Technical SEO 5/51 and full regression 176/1235; exact decoded schema payload, canonical/indexation/sitemap/robots/direct-redirect checks, PHPStan 8, Pint and build pass | Structured-data slice passes; landing/browser/production gates remain |
| 35 | V1 / Layer 3/4 | Merchant and Analytics | `IN PROGRESS — PROVIDER/ATTRIBUTION/INTEGRATION GATES` | Provider-neutral scope allowed by approved domain contracts; named providers remain blocked by D-007 | Durable Merchant batches rebuild authoritative Catalog/Pricing/Inventory facts; Analytics enforces exact allow-list, consent/PII/dedupe and private-monitor controls; Order and Catalog producers use the transactional outbox; finish attribution, remaining producers, concrete providers and staging/load/privacy evidence | [Step 35 task/evidence](./docs/tasks/step-35-merchant-analytics.md), [Event Catalog](./docs/events/event-catalog.md), Growth/Foundation contracts/actions/relay/Admin/tests | Merchant/Analytics focused 8/51 and full regression 176/1235; partial retry, provider-disabled safety, consent suppression, PII rejection, event dedupe and private 2FA monitor pass | Provider-neutral slice passes; no duplicate delivery identity; external/provider and attribution gates remain |
...
| 48 | V1 then V2 rerun / Layer 2 | Event Catalog | `IN PROGRESS — ORDER/CATALOG FACT/OUTBOX SLICE` | Steps 05, 07 and ADR-0004 passed; update with each producer/consumer | Versioned internal `commerce.order.placed` and `catalog.projection.changed` facts use the MySQL transactional outbox; released Catalog facts invalidate Search reliably; relay uses durable identity, SKIP LOCKED claim, lease recovery, bounded retry/dead-letter and private operations monitor; finish remaining facts/consumers/PII/retention | [Event Catalog](./docs/events/event-catalog.md), migration 000018, Foundation/Catalog/Search dispatch actions/command/Admin/tests | Focused Checkout/Quotation/Outbox/Foundation 18/120, Catalog/Search/Outbox 15/84 and full 176/1235; atomic rollback, versioned attribute facts, duplicate/conflict, retry/dead-letter/private monitor pass; MySQL relay concurrency remains | Initial producers and relay are idempotent; catalog/release gates remain |
...
| `23` | `DONE — PROVIDER-NEUTRAL CORE` | Payment truth, verified callback/idempotency/reconciliation, Order/Inventory binding and full-refund controls passed; named online provider remains disabled |
...
| `33` | `IN PROGRESS — MYSQL/BROWSER GATES` | Type-specific replacement/unpublish/scheduler, governed media and Admin/public safety pass; isolated MySQL/browser gates remain |
...
| `48` | `IN PROGRESS — ORDER/CATALOG FACT/OUTBOX SLICE` | Checkout/Quote and Catalog atomically persist versioned facts; released Catalog facts reliably invalidate Search; relay retry/dead-letter evidence passes; remaining catalog/consumer/MySQL concurrency gates remain |
| `49–54` | `IN PROGRESS — BOOTSTRAPPED` | Cross-cutting controls exist; executable release evidence remains open |

The immediate next action is to extend the Step `48` catalog only for approved business facts while keeping external Analytics emission blocked until consent/attribution is captured. Step `33` retains only isolated MySQL/browser evidence; no test migration will target the live `kaiyo` database. Public Contact lead capture and attribution remain contract-gated; Steps `30`–`32` retain explicit missing-contract/KPI/NFR sub-gates. Named external providers and missing VAT/shipping configuration remain fail-closed until approved contracts/configuration exist.
