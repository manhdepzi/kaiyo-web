...
final readonly class UpdateProduct
{
    ...
    /** @param array{name?: string, slug?: string, description?: string|null, status?: string} $changes */
    public function execute(UserAccount $actor, Product $product, int $expectedVersion, array $changes): Product
    {
        ...
        $allowed = array_intersect_key($changes, array_flip(['name', 'slug', 'description', 'status']));
